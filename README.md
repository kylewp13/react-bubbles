...
- [x] Explain what a token is used for.
  ...
  A token is used to authenticate the user on a request using the header from a string of cryptic text.

- [X] What steps can you take in your web apps to keep your data secure?

    1. Ask Professionals to “Attack” Your Application
    2. Invest in Security Experts
    3. Sanitize the User Output

- [X] Describe how web servers work.

    Servers work through a fairly simple system of request and response serving up pages of web content that you’ve requested
